...
public struct MirrorConfig: Codable, Sendable {
    ...
    public static let `default`: MirrorConfig = {
        ...
        return MirrorConfig(
            ...
            destinationPath: "\(home)/DevMirror",
            excludedNames: [
                "node_modules", ".next", "dist", "build", ".build",
                ".swiftpm", "DerivedData", "xcuserdata", "Pods",
                ".dart_tool", ".gradle", "target", "__pycache__",
                ".venv", ".DS_Store", ".idea", "Index.noindex",
                "vendor", ".cache", "venv", "coverage", ".turbo",
                ".nx", ".yarn", ".nuxt", ".svelte-kit", ".angular",
                ".pytest_cache", ".mypy_cache", ".ruff_cache", ".tox",
                ".m2", ".terraform", ".vs", ".eslintcache",
                "zig-cache", "zig-out", "htmlcov", ".cargo",
                "CMakeFiles", "_site", "dSYMs", ".sass-cache",
            ],
